...
CALL DietaJa_test.AssociarPorcaoRefeicoesDietaDiaDaSemana('1,3,4', '4,3,2', 3, 2, 1);
...
DECLARE cursor1 CURSOR FOR SELECT LogContent, LogDate, LogType FROM DietaJa_test.Log;
