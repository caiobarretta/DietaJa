...
ALTER TABLE DietaJa_test.PorcaoDeAlimentoDiasDaSemanaDietaRefeicao ADD CONSTRAINT FK_PorcaoDeAlimento_PDADSDR
FOREIGN KEY (ID_PorcaoDeAlimento) REFERENCES DietaJa_test.PorcaoDeAlimento (ID_PorcaoDeAlimento);

ALTER TABLE DietaJa_test.PorcaoDeAlimentoDiasDaSemanaDietaRefeicao ADD CONSTRAINT FK_Dieta_PDADSDR
FOREIGN KEY (ID_Dieta) REFERENCES DietaJa_test.Dieta (ID_Dieta);